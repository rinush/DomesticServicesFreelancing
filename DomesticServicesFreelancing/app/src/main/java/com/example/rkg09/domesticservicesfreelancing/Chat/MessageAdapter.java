...
import java.util.ArrayList;
    ...
    public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MessageViewHolder> {
        ...
        public void onBindViewHolder(@NonNull final MessageViewHolder holder, final int position) {
            ...
            holder.mMessage.setTextSize(18.0f);
            if(messageList.get(position).getSenderId().contentEquals(FirebaseAuth.getInstance().getUid())) {
                holder.mMessage.setBackgroundResource(R.color.green);
            }
            else{
                holder.mMessage.setBackgroundResource(R.color.white);
            }
