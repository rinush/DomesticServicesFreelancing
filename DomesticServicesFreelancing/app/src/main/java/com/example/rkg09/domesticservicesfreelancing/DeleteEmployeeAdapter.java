 ...
 */
    public class DeleteEmployeeAdapter extends BaseAdapter {
        ...
        public DeleteEmployeeAdapter(Context context, ArrayList arrSchoolData,ArrayList arrSchoolData1, ArrayList arrSchoolData2, ArrayList arrSchoolData3, ArrayList arrSchoolData4, ArrayList arrSchoolData5) {
            super();
            mContext = context;
        ...
        public View getView(final int position, View view, ViewGroup parent) {
            ...
            btnAction.setText("Delete Employee");
      ...
      public void delete_employee(final int position){
          ...
          ref.addValueEventListener(new ValueEventListener() {
              ...
              public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                  ...
                  for (DataSnapshot ds : dataSnapshot.getChildren()) {
                      if (i == position) {
                          if (ds.exists()) {
                              employee_id = ds.getKey().toString();
                              //Toast.makeText(mContext,""+customer_id,Toast.LENGTH_LONG).show();
                              DatabaseReference ref1 = FirebaseDatabase.getInstance().getReference().child("Users").child("Employees").child(employee_id).child("Address");
                              ref1.setValue(null);
                              ref1 = FirebaseDatabase.getInstance().getReference().child("Users").child("Employees").child(employee_id).child("Contact");
                              ref1.setValue(null);
                              ref1 = FirebaseDatabase.getInstance().getReference().child("Users").child("Employees").child(employee_id).child("Designation");
                              ref1.setValue(null);
                              ref1 = FirebaseDatabase.getInstance().getReference().child("Users").child("Employees").child(employee_id).child("Email");
                              ref1.setValue(null);
                              ref1 = FirebaseDatabase.getInstance().getReference().child("Users").child("Employees").child(employee_id).child("FirstName");
                              ref1.setValue(null);
                              ref1 = FirebaseDatabase.getInstance().getReference().child("Users").child("Employees").child(employee_id).child("LastName");
                              ref1.setValue(null);
                              ref1 = FirebaseDatabase.getInstance().getReference().child("Users").child("Employees").child(employee_id).child("Password");
                              ref1.setValue(null);
                          }
                          break;
                      }
